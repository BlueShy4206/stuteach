...
//echo '<IMG NAME="TOP_IMG" id="TOP_IMG" WIDTH="960" HEIGHT="58" SRC="images/stu_inner_2.jpg">';
...
//		if (!isset($mainfile)) { include("mainfile.php"); }
	...
	//$login_name = (date("Y")-1911).substr($user_data->user_id,0 , ($user_data->user_id.length)-2);
        $login_name = $user_data->user_id;
	echo "<font class=\"title1\"><center><br><br>";
	//print_r($user_data);
echo "<br><font size = \"5\" style=\"font-family:標楷體;\" >本人為&nbsp;&nbsp;</font><font size = \"5\" color=\"blue\" style=\"font-family:標楷體;\"><u>".$user_data->uname."</u></font><font size = \"5\" style=\"font-family:標楷體;\" >&nbsp;&nbsp;&nbsp;准考證號碼：<font size = \"5\" color=\"blue\" style=\"font-family:Times New Roman;\"><u>".$login_name."</u></font>，我確認上述個人資料正確，";
