                  ...
                  <tr>
                    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                        ...
                        <td align="left" class="d_s_title08">　'.$class_group.'</td>
                     ...
                     <tr>
                       <td>
                         ...
                         <table width="100%" align="center" border="0" cellpadding="4" cellspacing="0" class="d_tableline">
                           <tr>';
		           $print_data.='<td width="55%" align="center" background="'._THEME_IMG.'tit_bg03.gif" class="d_s_title41">各能力指標</td>';
               $print_data.='<td '.$tmp.' colspan='.$xj.' align="center" background="'._THEME_IMG.'tit_bg03.gif" class="d_s_title41">次級量尺分數</td>'."\n";
		           $tmp="";
               if($this->test_times>1)
                   {
                 //$tmp='colspan="'.$this->test_times.'"';
