...
//        echo '<form method="post" action="'.$caller->server['PHP_SELF'].'" onSubmit="'.$loginOnClick.'">'."\n";
        ...
        echo '<table WIDTH="300" HEIGHT="80" border="0" cellpadding="2" cellspacing="0" summary="login form" align="right">'."\n";
        echo '<tr>'."\n";
        echo '    <td colspan="2" >'.$status.'</td>'."\n";
        echo '</tr>'."\n";
        echo '<tr>'."\n";
        echo '    <td align="right"><font  size="4" style="font-family:標楷體;">准考證號碼：</td>'."\n";
        echo '    <td><input type="text" id="'.$caller->getPostUsernameField().'" name="'.$caller->getPostUsernameField().'" value="' . $username . '" /></td>'."\n";
        echo '</tr>'."\n";
        echo '<tr>'."\n";
        echo '    <td align="right"><font  size="4" style="font-family:標楷體;">密碼：</td>'."\n";
        echo '    <td><input type="password" id="'.$caller->getPostPasswordField().'" name="'.$caller->getPostPasswordField().'" /></td>'."\n";
        echo '</tr>'."\n";
        echo '<tr>'."\n";
        
        //onClick=" '.$loginOnClick.' "
        echo '    <td colspan="2" align="center"><input value="登入" id="doLogin" name="doLogin" type="submit" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>'."\n";
        echo '</tr>'."\n";
        echo '</table>'."\n";
        // Might be a good idea to make the variable name variable 
