...
class LanguageConv {
	...
	elseif( $aFF === FF_CHINESE || $aFF === FF_BIG5) {
...
// CONSTRUCTOR
	...
	$this->font_files=array(
	    ...
	    FF_CHINESE => array(FS_NORMAL=>CHINESE_TTF_FONT, FS_BOLD=>CHINESE_TTF_FONT, FS_ITALIC=>'mingliu.ttc', FS_BOLDITALIC=>'mingliu.ttc' ),
...
class Text {
    ...
    public $iWordwrap=0;
    protected $font_family=FF_CHINESE,$font_style=FS_NORMAL,$font_size=12;
