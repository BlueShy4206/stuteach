...
// Created: 	2001-02-04
// Ver:		$Id: jpgraph_radar.php 781 2006-10-08 08:07:47Z ljp $
//
...
// CONSTRUCTOR
	...
	$this->title = new Text();
	$this->title->SetFont(FF_CHINESE,FS_BOLD);
...
//("RadarPlot Unsupported Tick density: $densy");
    ...
    function SetTitles($title) {
		...
		for($i=0;$i<sizeof($title);$i++){
			$a[$i]=iconv('BIG5','UTF-8',$title[$i]);
			//$a[$i]=iconv('UTF-8','BIG5',$a[$i]);
		}
		*/
	//$this->axis_title = iconv('BIG5','UTF-8',$title);
