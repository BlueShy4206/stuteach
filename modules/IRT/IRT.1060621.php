...
$sql = "select * from concept_item where cs_id = '$cs_id' and paper_vol = '".$paper_vol."' and item_num='$IRT->select_item_num'";
...
//$PImgProp['item_filename']=GetImageSize($_SESSION['cs_path'].$question->item_filename);  //圖片大小
//$showfig=explode(".", $item_filename);
