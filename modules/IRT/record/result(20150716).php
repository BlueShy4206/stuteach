    ...
    */  
    ...
    if($result==TRUE){
      ...
      $RedirectTo="Location: modules.php?op=modload&name=ExamResult&file=classReports_right_now&report=1&q_user_id=".$user_id."&q_cs_id=".$cs_id;
  		...
  		//Header($RedirectTo);
  	echo '<TABLE CELLPADDING="0" CELLSPACING="0" BORDER="0" align="center" background="images/stuteach_960.jpg" BORDER="0" WIDTH="960" HEIGHT="719">';	echo '<center><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><h1><font style="font-family:標楷體;" >測驗完畢，謝謝您的參與！</font></h1><br><br><br><font size = "5" style="font-family:標楷體;" >【</font><a href="index.php?act=logout"><font size = "5" style="font-family:標楷體;" >登出</font></a><font size = "5" style="font-family:標楷體;" >】</font><br><br><br><br><br><br></center>';
  		echo "</td>";
  		echo '</div>';
  		echo '</TD>';
