...
function chooseUSER(){
	...
	$sql = "select distinct city_code, organization_id, exarea from user_info ORDER BY city_code";
...
function listUSER($org){
	...
	$sql = "select * from user_info, user_status where user_info.organization_id = '$org[1]' and user_info.exarea='$org[2]' and user_info.user_id=user_status.user_id and user_status.access_level<'".$user_data->access_level."' order by user_status.access_level, user_info.user_id";
