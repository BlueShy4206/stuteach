...
function EPadd2course($CourseID, $EPids, $ExamType, $TestTime){
	...
	if($con!=$i){   
        ...
        (cs_id, paper_vol, exam_paper_id, course_id, year, seme, type_id_irt, type_id_e, type_id_s, type_id_t, num_e, item_length, test_time, noABC, testlet) 
        VALUES 
        (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)
      ';
			$data = array($cs_id, $paper_vol, $curr_EPid, $CourseID[1], $CourseID[0], '0', $ExamType['irt'], $ExamType['e'], $ExamType['s'], $ExamType['t'], $ExamType['num_e'], $ExamType['item_l'], $TestTime, $ExamType[noABC], $ExamType[testlet]);
