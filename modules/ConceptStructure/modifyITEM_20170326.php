...
function deleteITEM($opt){
	...
	//echo "<pre>";
	//print_r($_REQUEST);
	$RedirectTo='Location: modules.php?op=modload&name=ConceptStructure&file=modifyEP&opt=listEP&opt2=modifyEP&unit_item[0]='.$_REQUEST['pid'].'&unit_item[1]='.$_REQUEST['sid'].'&unit_item[2]='.$_REQUEST['vid'].'&unit_item[3]='.$_REQUEST['uid'].'&unit_item[4]='.$_REQUEST['paper'];
	Header($RedirectTo);
}
